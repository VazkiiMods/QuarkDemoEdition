...
public class ModEntityTypes {
	...
	public static final EntityType<Pickarang> PICKARANG = FabricEntityTypeBuilder.<Pickarang>create(MobCategory.MISC, Pickarang::new).dimensions(EntityDimensions.fixed(0.4F, 0.4F)).trackRangeChunks(8).build();
	...
	public static void init() {
		...
		Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(Quark.MOD_ID, "pickarang"), PICKARANG);
	}
}
